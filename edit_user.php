...
if(!in_array('Admin', $roles_arr)) {
    $_SESSION['access_denied'] = "Only Admins can edit users.";
...
if(isset($_POST['update'])) {
    ...
    if(!empty(trim($_POST['password']))) {
        $pw = mysqli_real_escape_string($conn, trim($_POST['password']));
        $password_part = ", password='$pw'";
    }
    ...
    // Check if another user uses that email
    ...
    if(mysqli_num_rows($check) > 0) {
        ...
        mysqli_query($conn, "UPDATE users SET name='$name', email='$email', role='$role_str', extra_permissions='$extra_permissions_json' $password_part WHERE id='$id'");
...
<div class="topbar">
    <div class="topbar-left">
        ...
        <div class="topbar-title">
            <h1>Edit User</h1>
            <p>Update team member details and role</p>
        </div>
    </div>
...
<div class="content-wrapper">
    <div class="page-card" style="max-width: 640px; margin: 0 auto;">
        <div class="page-card-header">
            <h2><i class="bi bi-pencil-square"></i> Edit: <?php echo htmlspecialchars($u['name']); ?></h2>
        </div>
        <div class="page-card-body">
            ...
            <form method="POST">
                <?php $user_perms = json_decode($u['extra_permissions'] ?? '{}', true); ?>
                ...
                <div class="form-section">
                    <label class="form-label">New Password <small style="color:var(--gray-400);">(leave blank to keep current)</small></label>
                ...
                <div class="form-section">
                    ...
                    <?php $user_roles = array_map('trim', explode(',', $u['role'])); ?>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid var(--gray-200);">
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="roles[]" value="Admin" style="margin-top: 4px;" <?php echo in_array('Admin', $user_roles) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="roles[]" value="Supervisor" style="margin-top: 4px;" <?php echo in_array('Supervisor', $user_roles) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="roles[]" value="Campaign Manager" style="margin-top: 4px;" <?php echo in_array('Campaign Manager', $user_roles) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="roles[]" value="Finance Manager" style="margin-top: 4px;" <?php echo in_array('Finance Manager', $user_roles) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="roles[]" value="Client Manager" style="margin-top: 4px;" <?php echo in_array('Client Manager', $user_roles) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="roles[]" value="Staff" style="margin-top: 4px;" <?php echo in_array('Staff', $user_roles) ? 'checked' : ''; ?>>
                            <div>
                ...
                <div class="form-section mt-4" style="margin-top: 24px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr; gap: 12px; background: #fff; padding: 16px; border-radius: 8px; border: 1px solid var(--gray-200);">
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="perm_invoice_campaigns" style="margin-top: 4px;" <?php echo !empty($user_perms['can_invoice_campaigns']) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="perm_invoice_monthly_clients" style="margin-top: 4px;" <?php echo !empty($user_perms['can_invoice_monthly_clients']) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="perm_invoice_web_projects" style="margin-top: 4px;" <?php echo !empty($user_perms['can_invoice_web_projects']) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="perm_view_income" style="margin-top: 4px;" <?php echo !empty($user_perms['can_view_income']) ? 'checked' : ''; ?>>
                            <div>
                        ...
                        <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="perm_send_whatsapp" style="margin-top: 4px;" <?php echo !empty($user_perms['can_send_whatsapp']) ? 'checked' : ''; ?>>
                            <div>
