...
if(!can('retainers') && !can('web_projects')) {
    die("Access denied.");
}
...
SELECT services.*, clients.name as client_name, clients.email as client_email, clients.phone as client_phone
FROM services
...
$is_retainer = ($invoice['service_type'] == 'Monthly Service Retainer');

if ($is_retainer && !has_permission('can_invoice_monthly_clients')) {
    die("Access denied: You do not have permission to invoice Monthly Clients.");
}
if (!$is_retainer && !has_permission('can_invoice_web_projects')) {
    die("Access denied: You do not have permission to invoice Web Projects.");
}
...
<head>
    ...
    <title>Invoice - <?php echo htmlspecialchars($invoice['service_name']); ?></title>
    <!-- Google Fonts -->
    ...
    <div class="invoice-container">
        ...
        <div class="details-section">
            ...
            <div class="invoice-info-box">
                ...
                <table class="info-table">
                    ...
                    <?php endif; ?>
                    <?php if($is_retainer && !empty($invoice['payment_due_date']) && $invoice['payment_due_date'] != '0000-00-00'): ?>
                    <tr>
                        <td class="info-label">Due Date</td>
                        <td class="info-value"><?php echo date('d M, Y', strtotime($invoice['payment_due_date'])); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr>
        ...
        <table class="modern-table">
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="item-title"><?php echo htmlspecialchars($invoice['service_name']); ?></div>
                        <div class="item-desc">
                            <?php echo $is_retainer ? 'Monthly Service Retainer Fee' : 'Website Development Project Fee'; ?>
                        </div>
                    </td>
        ...
        <div class="totals-section">
            <div class="totals-box">
                ...
                <div class="total-row">
                    <span class="total-label" style="color: #059669;">Advance Received</span>
                    <span class="total-value" style="color: #059669;">- Rs <?php echo number_format($advance, 2); ?></span>
                </div>
